...
fit_missing = BDcocolasso::coco(Z=Z_missing,y=y_missing,n=n_missing,p=p_missing,step=100,K=4,mu=10,tau=NULL, 
                                etol = 1e-4,noise = "missing", block=FALSE, penalty="lasso")
...
fit_additive = BDcocolasso::coco(Z=Z_additive,y=y_additive,n=n_additive,p=p_additive,center.Z = FALSE, step=100,K=4,
                                 mu=10,tau=0.3,etol = 1e-4,noise = "additive",block=FALSE, penalty="lasso")
